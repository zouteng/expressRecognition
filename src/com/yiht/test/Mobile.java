...
public class Mobile {
	...
	public static void main(String[] args) {
		...
		// System.out.println(Mobile.getSoapRequest("13272303204"));
		 //System.out.println(Mobile.getSoapInputStream("18672695692"));
		System.out.println(Mobile.getMobileNoTrack("15106200601"));
		//System.out.println(Mobile.getMobileNoTrack("15151523966"));
	}
